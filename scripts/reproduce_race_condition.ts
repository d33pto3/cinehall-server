    ...
    try {
        ...
        results.forEach((r, i) => {
            if (r.status === 'fulfilled') {
                console.log(`Req ${i+1}: Success (Status: ${i===0?res1.statusCode:res2.statusCode})`);
                if(i===0 && res1.statusCode !== 201) console.log(`Req 1 Payload:`, res1.body);
                if(i===1 && res2.statusCode !== 201) console.log(`Req 2 Payload:`, res2.body);
